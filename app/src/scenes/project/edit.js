            ...
            {({ values, handleChange, handleSubmit, isSubmitting }) => (
              <React.Fragment>
                ...
                <div className="py-3 px-4">
                  <div className="flex gap-4 flex-wrap">
                    <div className="w-full md:w-[260px] mt-2">
                      ...
                      <input className="projectsInput text-[14px] font-normal text-[#212325] rounded-[10px]" name="name"
                             disabled value={values.name} onChange={handleChange}/>
                    </div>
                    <div className="w-full md:w-[260px] mt-2">
                      <div className="text-[14px] text-[#212325] font-medium	">Lead by name</div>
                      <input className="projectsInput text-[14px] font-normal text-[#212325] rounded-[10px]" name="lead"
                             value={values.lead} onChange={handleChange}/>
                    </div>
                    <div className="w-full md:w-[260px] mt-2">
                      <div className="text-[14px] text-[#212325] font-medium	">Status</div>
                      <select className="projectsInput text-[14px] font-normal text-[#212325] rounded-[10px]"
                              name="status" value={values.status} onChange={handleChange}>
                        <option value=""></option>
                  ...
                  <div className="w-full mt-3">
                    ...
                    <input className="projectsInput text-[14px] font-normal text-[#212325] rounded-[10px]"
                           name="website" value={values.website} onChange={handleChange}/>
                  </div>
                ...
                <div className="flex ml-3 mt-2">
                  ...
                  <button
                      className="ml-[10px] bg-[#F43F5E] text-[16px] font-medium text-[#fff] py-[12px] px-[22px] rounded-[10px]"
                      onClick={deleteData}>
                    Delete
                  </button>
                </div>
